public class PlaylistTester {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < p.vibes.size(); i++) {
            System.out.println(p.vibes.get(i).getName() + " by " + p.vibes.get(i).getArtist() + " (" + p.vibes.get(i).songDuration() + ")");
        }
        ...
        for (int i = 0; i < p.vibes.size(); i++) {
            if (p.vibes.get(i).isLiked()) {
                System.out.println(p.vibes.get(i).getName() + " by " + p.vibes.get(i).getArtist() + " (" + p.vibes.get(i).songDuration() + ") --liked");
            } else {
                System.out.println(p.vibes.get(i).getName() + " by " + p.vibes.get(i).getArtist() + " (" + p.vibes.get(i).songDuration() + ")");
            }
        }
